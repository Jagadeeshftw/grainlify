    ...
    <div className="space-y-6">
      ...
      {onBack && (viewingUserId || viewingUserLogin) && (
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-[12px] backdrop-blur-[30px] border font-medium text-[14px] hover:bg-white/[0.2] transition-all ${
            theme === "dark" ? "bg-[#3d342c]/[0.4] border-white/15 text-[#d4c5b0]" : "bg-white/[0.15] border-white/25 text-[#2d2820]"
          }`}
        >
            ...
            <div className="flex-1 pt-1">
              ...
              {/* {!isLoadingProfile && (profileData?.bio || profileData?.website) && (
                <div className="mb-4 space-y-3">
                  {profileData.bio && (
                    <p className={`text-[15px] leading-relaxed transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>{profileData.bio}</p>
                  )}
                  {profileData.website && (
              ...
              {!isLoadingProfile && (
                <div className="flex items-center justify-center md:justify-start gap-1 md:gap-3 flex-wrap mb-4">
                  ...
                  >
                    <Shield className={`w-4 h-4 ${profileData?.kyc_verified ? "text-[#16a34a]" : theme === "dark" ? "text-[#9ca3af]" : "text-[#6b7280]"}`} />
                  </div>
                  {/* Telegram */}
                ...
                <div className="flex items-center gap-8">
                  <div className="relative flex items-center gap-3 group/stat">
                    ...
                    {isLoadingProfile ? (
                      ...
                      >
                        Contributor on{" "}
                        <span className={`font-black text-[16px] transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>
                    ...
                    {contributorModalOpen && projects.length > 0 && (
                      <div
                        className={`absolute z-[200] top-full mt-2 left-0 w-[260px] rounded-[18px] border shadow-lg ${
                          theme === "dark" ? "bg-[#3a3228] border-white/15" : "bg-[#e4d4c0] border-white/40"
                        }`}
                      >
                        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
                          <div className="flex items-center gap-2">
                            <Users className="w-4 h-4 text-[#c9983a]" />
                            <span className={`text-[13px] font-semibold ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Projects contributed to</span>
                          </div>
                          <button type="button" onClick={() => setContributorModalOpen(false)} className="text-[13px] text-[#c9983a] hover:text-[#a67c2e]">
                            ×
                          </button>
                        </div>
                            ...
                            return (
                              ...
                              >
                                {project.owner_avatar_url ? (
                                  <img src={project.owner_avatar_url} alt="" className="w-8 h-8 rounded-[10px] object-cover flex-shrink-0" />
                                ) : project.language ? (
                      ...
                      >
                        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-[13px] font-semibold ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Projects led</span>
                          </div>
                          <button type="button" onClick={() => setLeadModalOpen(false)} className="text-[13px] text-[#c9983a] hover:text-[#a67c2e]">
                            ×
                          </button>
                        </div>
                        <div className="max-h-[260px] overflow-y-auto p-2 space-y-1">
            ...
            <div className="relative backdrop-blur-[40px] rounded-[28px] border-[3.5px] border-white/50 shadow-[0_15px_60px_rgba(201,152,58,0.5),inset_0_2px_4px_rgba(255,255,255,0.5),0_0_60px_rgba(255,215,0,0.2)] p-10 min-w-[200px] text-center group-hover/rank:scale-105 group-hover/rank:shadow-[0_20px_80px_rgba(201,152,58,0.6),inset_0_2px_4px_rgba(255,255,255,0.6)] transition-all duration-500 bg-gradient-to-br from-[#c9983a]/40 via-[#d4af37]/30 to-[#c9983a]/25">
                ...
                {isLoadingProfile ? (
                  ...
                  >
                    ...
                    <span className="text-[36px] align-super">
                      {profileData.rank.position === 1 ? "st" : profileData.rank.position === 2 ? "nd" : profileData.rank.position === 3 ? "rd" : "th"}
                    </span>
                  </div>
                ) : (
              ...
              {isLoadingProfile ? (
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-[10px] bg-white/[0.3] border-2 border-[#c9983a]/50 shadow-[0_3px_12px_rgba(201,152,58,0.3),inset_0_1px_2px_rgba(255,255,255,0.4)]">
                  ...
                  <span className="text-[13px] font-black text-[#c9983a] uppercase tracking-[0.15em]">{profileData?.rank?.tier_name || "Bronze"}</span>
                </div>
              )}
      ...
      <div className="backdrop-blur-[40px] bg-white/[0.12] rounded-[24px] border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-8 relative overflow-hidden group/projects">
        ...
        <div className="relative flex items-center justify-between mb-6">
          <h2 className={`text-[20px] font-bold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Projects led / Most</h2>
          <button
            type="button"
        ...
        <div className={`relative grid gap-5 ${showAllProjects ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" : "grid-cols-3"}`}>
          {isLoadingProjects ? (
            ...
            Array.from({ length: 3 }).map((_, idx) => (
              <div
                key={idx}
                className={`backdrop-blur-[20px] rounded-[16px] border p-5 ${theme === "dark" ? "bg-white/[0.08] border-white/10" : "bg-white/[0.15] border-white/25"}`}
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-[12px] bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-md overflow-hidden group-hover/project:scale-110 group-hover/project:rotate-6 transition-all duration-300">
                      {project.owner_avatar_url ? (
                        <img src={project.owner_avatar_url} alt={projectName} className="w-full h-full object-cover" />
                      ) : project.language ? (
                    ...
                    <div className="flex-1">
                      <h3
                        className={`text-[16px] font-bold group-hover/project:text-[#c9983a] transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}
                      >
                        {projectName}
                      </h3>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className={`text-[10px] font-medium transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>Rewards</span>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className={`text-[10px] font-medium transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>Merged PRs</span>
                      </div>
                      <div className={`text-[20px] font-bold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>
            ...
            <EmptyState variant="no-contributions" isDark={theme === "dark"} ctaLabel="Browse projects" onCta={() => {}} />
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="backdrop-blur-[40px] bg-white/[0.12] rounded-[24px] border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className={`text-[16px] font-bold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Most active languages</h2>
          </div>
          ...
          <div className="space-y-3">
            {isLoadingProfile ? (
              ...
              Array.from({ length: 3 }).map((_, idx) => (
                <div key={idx} className="backdrop-blur-[20px] bg-white/[0.15] rounded-[12px] border border-white/25 p-4">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`text-[15px] font-semibold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>{language.name}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      {Array.from({ length: 3 }).map((_, idx) => (
                        <div
                          ...
                          className={`w-2.5 h-2.5 rounded-full transition-all ${
                            idx < language.activityLevel ? "bg-[#c9983a] shadow-[0_0_8px_rgba(201,152,58,0.6)] group-hover:scale-125" : "bg-white/20"
                          }`}
                        />
                      ))}
                    </div>
              ...
              <div className={`text-center py-4 ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>No languages found</div>
            )}
          </div>
        </div>
        ...
        <div className="backdrop-blur-[40px] bg-white/[0.12] rounded-[24px] border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className={`text-[16px] font-bold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Most active ecosystems</h2>
          </div>
          ...
          <div className="space-y-3">
            {isLoadingProfile ? (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`text-[15px] font-semibold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>{ecosystem.name}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      {Array.from({ length: 3 }).map((_, idx) => (
                        <div
                          key={idx}
                          className={`w-2.5 h-2.5 rounded-full transition-all ${
                            idx < ecosystem.activityLevel ? "bg-[#c9983a] shadow-[0_0_8px_rgba(201,152,58,0.6)] group-hover:scale-125" : "bg-white/20"
                          }`}
                        />
                      ))}
                    </div>
              ...
              <div className={`text-center py-4 ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>No ecosystems found</div>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="backdrop-blur-[40px] bg-white/[0.12] rounded-[24px] border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-6 sm:p-8 relative overflow-hidden group/rewards">
        ...
        <div className="relative">
          <RewardsChart data={rewardsData} totalRewards={totalRewards} isLoading={false} />
        </div>
      </div>
      ...
      <div className="backdrop-blur-[40px] bg-white/[0.12] rounded-[24px] border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-8">
        <h2 className={`text-[20px] font-bold mb-6 transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Contributions Activity</h2>
          ...
          <div className="space-y-2">
            {Object.entries(contributionsByMonth).map(([month, items]) => (
              <div key={month} className="backdrop-blur-[20px] bg-white/[0.08] rounded-[12px] border border-white/20 overflow-hidden">
                ...
                <button onClick={() => toggleMonth(month)} className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-white/[0.05] transition-all group">
                    ...
                    {items.map((item, idx) => {
                      ...
                      return (
                        <div key={item.id} className="relative">
                          ...
                          {idx < items.length - 1 && <div className="absolute left-[20px] top-[36px] bottom-[-8px] w-[2px] bg-gradient-to-b from-white/25 to-white/8" />}
                          ...
                          >
                            ...
                            {item.type !== "review" && IconComponent && (
                              <div className="relative z-10 flex items-center gap-2.5 flex-shrink-0">
                                ...
                                <div className={`px-3.5 py-1.5 rounded-[6px] ${iconBgColor} shadow-[0_3px_10px_rgba(0,0,0,0.25)]`}>
                                  <span className="text-[14px] font-bold text-white">{item.number}</span>
                                </div>
                              </div>
                            )}
                            ...
                            {item.type === "review" && (
                              <div className="relative z-10 flex-shrink-0 w-[120px]">
                                <span className={`text-[15px] font-semibold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Review:</span>
                              </div>
                            )}
