...
import { Search, ChevronDown, Award, Briefcase, GitPullRequest, FolderGit2, Trophy, Github, Code, Globe, Sparkles, TrendingUp, Star, Users, GitFork, DollarSign, GitMerge, Calendar, ChevronRight, Filter, Circle, Eye, Crown, Link, ArrowLeft, ShieldCheck } from 'lucide-react';
                ...
                <div className="flex items-center gap-3 flex-wrap mb-4">
                  ...
                  {profileData?.is_kyc_verified ? (
                    ...
                    <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center cursor-not-allowed ${
                      ...
                      <ShieldCheck className={`w-4 h-4 ${theme === 'dark' ? 'text-[#9ca3af]' : 'text-[#6b7280]'}`} />
                    </div>
                  )}
                </div>
              )}
