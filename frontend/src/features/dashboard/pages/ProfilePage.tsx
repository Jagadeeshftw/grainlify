          ...
          <div className="flex items-start gap-7">
            ...
            <div className="flex-1 pt-1">
              ...
              {isLoadingProfile ? (
                ...
                <div className="mb-4">
                  <h1 className={`text-[42px] font-black tracking-tight leading-none transition-colors ${theme === 'dark'
                    ? 'text-[#f5f5f5]'
                    ...
                    {(() => {
                      ...
                      const login = viewingUser?.login || user?.github?.login || 'Loading...';
                  ...
                  {/* Show login handle below name if name is displayed */}
                  {(profileData?.first_name || profileData?.last_name) && (
                    <div className={`text-[18px] font-medium mt-1 ${theme === 'dark' ? 'text-[#a1a1aa]' : 'text-[#6b7280]'}`}>
