  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4 sm:gap-0 text-center sm:text-left">
        <div>
          <h1 className={`text-[24px] sm:text-[32px] font-bold mb-2 transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>Open-Source Week</h1>
          <p className={`text-[14px] sm:text-[16px] transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>
            ...
            >
              <div className="flex flex-col sm:flex-row items-start justify-between mb-6 gap-4 sm:gap-0">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className={`text-[18px] sm:text-[22px] font-bold mb-2 transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>
                      {event.title}
                    </h3>
                    <span
                      className={`px-3 py-1.5 rounded-[10px] text-[11px] sm:text-[12px] font-semibold ${
                        theme === "dark" ? "bg-[#c9983a]/20 border border-[#c9983a]/40 text-[#e8c77f]" : "bg-[#c9983a]/15 border border-[#c9983a]/30 text-[#6d5530]"
                      }`}
                    >
                      {event.statusLabel}
                    </span>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-6 border-t border-white/10 gap-6 sm:gap-0">
                <div className="grid grid-cols-2 gap-8 w-full sm:w-auto">
                  <div>
                    <div className={`text-[11px] sm:text-[12px] mb-1 transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>Start date</div>
                    <div className={`text-[14px] sm:text-[15px] font-semibold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>
                      {event.startDate}
                    </div>
                    <div className={`text-[11px] sm:text-[12px] transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>{event.startTime}</div>
                  </div>
                  <div>
                    <div className={`text-[11px] sm:text-[12px] mb-1 transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>End date</div>
                    <div className={`text-[14px] sm:text-[15px] font-semibold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>
                      {event.endDate}
                    </div>
                    <div className={`text-[11px] sm:text-[12px] transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>{event.endTime}</div>
                  </div>
                </div>
                <div className="w-full sm:w-auto">
                  <div className={`text-[11px] sm:text-[12px] mb-1 transition-colors ${theme === "dark" ? "text-[#d4d4d4]" : "text-[#7a6b5a]"}`}>Location</div>
                  <div className={`text-[14px] sm:text-[15px] font-semibold transition-colors ${theme === "dark" ? "text-[#f5f5f5]" : "text-[#2d2820]"}`}>
                    {event.location || "TBA"}
                  </div>
                </div>
