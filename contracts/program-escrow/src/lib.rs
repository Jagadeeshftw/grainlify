...
impl ProgramEscrowContract {
    ...
    /// escrow_client.release_prog_schedule_manual(&"Hackathon2024", &1);
    /// ```
    pub fn release_prog_schedule_manual(
        env: Env,
        program_id: String,
        schedule_id: u64,
    ) {
...
mod test {
    ...
    fn setup_program_with_schedule(
        ...
        token_client.transfer(authorized_key, &client.address, &total_amount);
