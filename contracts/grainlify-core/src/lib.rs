...
use grainlify_interfaces::{ConfigurableFee, FeeConfig as SharedFeeConfig, Pausable};
...
#[contractimpl]
impl ConfigurableFee for GrainlifyContract {
...
#[contractimpl]
impl Pausable for GrainlifyContract {
    fn pause(env: Env) {
        let admin: Address = env
            .storage()
            .instance()
