...
export function ProjectsTab() {
  ...
  const getLanguageIcon = (language: string) => {
    ...
    return icons[language] || { icon: language.substring(0, 2), color: 'bg-gray-500' };
  };
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="backdrop-blur-[20px] bg-white/[0.08] border-b border-white/20">
            <tr>
              <th className={`px-6 py-4 text-left text-[12px] font-semibold uppercase tracking-wider whitespace-nowrap transition-colors ${
          ...
          <tbody>
            {projects.map((project, idx) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-[13px] font-semibold transition-colors ${
                    theme === 'dark' 
                ...
                <td className={`px-6 py-4 text-[14px] font-semibold whitespace-nowrap transition-colors ${
                  theme === 'dark' ? 'text-[#f5f5f5]' : 'text-[#2d2820]'
                }`}>
                  {project.myRewards}
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <button className={`px-4 py-2 rounded-[8px] backdrop-blur-[20px] border text-[12px] font-medium transition-all ${
                    theme === 'dark'
